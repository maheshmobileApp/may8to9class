...
main(){
  runApp(MaterialApp(home:coulun))
}
...
Widgets -> statefull widget and stateless widget

container(orage) -> column-(2 container)
...
Scaffold(
        ...
        child: Column(
          ...
          children: [
            Container(
              color: Colors.blue,
              // child: Text(
              //   "helloskdfjnasklfjahlsfj asjflkasjfdkasjkfkjas kofjasjfaksodfjkaojf ko;asjfkoawejruqwiofnz  kvcnkfhdasihfkmasnfkashfiojashfj asfjioashfdjioashfo",
              //   maxLines: null,
      ...
      appBar: AppBar(title: Text("This is my first project")),
    ),
